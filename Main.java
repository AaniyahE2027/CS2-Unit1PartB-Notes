...
public class Main {
   ...
   public static void main(String []args) {
      ...
      Math.abs(-41); // works, but can't see results
      ...
      // meaning there are multiple versions of the same method, with the same name but differnet parameters
      double absValueDoub = Math.abs(-79.73); 
      System.out.println(absValueDoub);

      // Math.pow takes two arguements
      // and raises the first arg to the power on second
      ...
      // Create String onjects in 2 ways
      ...
      String str2 = "AP JAVA";
      System.out.println("Shortcut: " + str2); 
      ...
      String lastword = message.substring(8,15);
